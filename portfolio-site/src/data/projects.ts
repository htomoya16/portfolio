...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description:
      "Unity + SteamVR と ESP32 ベースのハプティックグローブを組み合わせた VR ピアノ触覚提示システム。グローブ型ハプティックデバイスを用い、指屈曲量と鍵盤接触状態に基づいて触覚フィードバックを制御することで、XR 空間におけるピアノ演奏時の鍵盤接触感を再現するシステムを設計・実装・評価した卒業研究。",
    tech: ["Unity", "SteamVR", "ESP32", "サーボモータ", "ポテンショメータ"],
  ...
  },
  {
    ...
    tech: ["ToFセンサ", "圧力センサ", "サーボモータ", "Raspberry Pi 4", "Python"],
