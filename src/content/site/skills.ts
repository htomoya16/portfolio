export const skillsCopy = {
  ...
  lead: 'バックエンドを中心に学習と個人開発を進めています。全体的な経験はまだ浅く、実務経験がないため、実務レベルの設計・運用・改善判断はこれから積み上げる領域だと認識しています。特にバックエンド領域で経験を重ね、信頼できる実装力へ伸ばしていきたいです。',
  note: 'レベルは下記基準に基づく自己評価です。実務経験を示すものではなく、現時点での学習・個人開発・研究での使用感を整理しています。',
